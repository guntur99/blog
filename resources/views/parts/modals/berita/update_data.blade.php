                                    ...
                                    <div class="row">
                                        <div class="col-8 m-auto text-white p-t-40 p-b-20">
                                            ...
                                            <p class="p-t-30 form-dark">
                                                <input type="search" id="search_by_berita" placeholder="Judul Berita" class=" form-control form-control-lg">
                                                <input type="search" id="search_by_berita_hapus" placeholder="Judul Berita" class="d-none form-control form-control-lg">
                                            </p>
