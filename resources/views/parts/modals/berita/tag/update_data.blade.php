                                    ...
                                    <div class="row">
                                        <div class="col-8 m-auto text-white p-t-40 p-b-20">
                                            ...
                                            <p class="p-t-30 form-dark">
                                                <input type="search" id="search_by_tag" placeholder="Nama Tag" class=" form-control form-control-lg" autocapitalize="off">
                                                <input type="search" id="search_by_tag_hapus" placeholder="Nama Tag" class="d-none form-control form-control-lg" autocapitalize="off">
                                            </p>
