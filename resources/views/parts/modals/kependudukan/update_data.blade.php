                            ...
                            <div class="container-pull col-md-12 mb-10 p-0" id="update_form">
                                ...
                                <div class="row mb-3 w-100" style="padding:0px 20px;">
                                    ...
                                    <div class="col-md-4 pl-3">
                                        ...
                                        <input type="text" class="form-control value_modal" id="u_kewarganegaraan"
                                ...
                                <div class="row w-100">
                                    <div class="col-md-12" id="button-modals" style="padding:20px 20px">
                                        <button type="button" id="simpan-data-update" class="btn ml-2 mr-2 btn-success float-right">
