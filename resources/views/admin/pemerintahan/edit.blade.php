                    ...
                    <div class="col-md-6 text-white p-b-30">
                        <div class="media">
                            <div class="media-body m-auto">
                                <h2><strong>Buat Informasi Baru</strong></h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" name="judul" id="judul"
                                     value="{{ $data->judul }}" placeholder="Judul Informasi" required>
                                ...
                                <div class="form-row col-md-12">
                                    <div class="form-group col-md-6">
                                        <div>
                                            <label for="kategori_id">Kategori Informasi</label>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div>
                                            <label for="last_name">Cover Informasi*</label>
                                ...
                                <div class="form-group col-md-12">
                                    <label for="desc">Isi Informasi </label>
                            ...
                            <div class="form-group">
                                <button type="submit" id="btn_update_berita" class="btn btn-primary ml-3 text-right float-right">Perbarui Informasi</button>
                            </div>
                        </div>
                    </div>
                    <!--widget card ends-->
...
@section('custom_script')
    ...
    <script>
        ...
        $('#btn_update_berita').click((e) => {
            ...
            axios.post('{{route("pemerintahan.desa.update")}}', formData).then((res) => {

                Swal.fire({
                    title: 'Success',
                    text: "Perbarui Informasi Berhasil!",
                    icon: 'success',
