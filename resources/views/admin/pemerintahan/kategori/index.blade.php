                ...
                <div class="row p-b-60 p-l-30 p-t-60">
                    ...
                    <div class="col-md-6 p-r-40">
                        <button id="buat_kategori_baru" type="button" class="btn  m-b-30 ml-2 mr-2 btn-primary text-white float-right"><i
                                class="mdi mdi-playlist-plus"></i> Buat Kategori
                        </button>
                    </div>
                    ...
                    <div class="card m-b-30">
                        <div class="card-body">
                            <div class="table-responsive p-t-10">
                                <table id="kategori-pemerintahan-table" class="table" style="width:100%">
                                    <thead>
                                    <tr>
                                        <th>No.</th>
                                        <th>Nama Kategori</th>
...
@section('custom_script')
    ...
    <script>
        ...
        var dataTable = $('#kategori-pemerintahan-table').DataTable({
            orderCellsTop: true,
            fixedHeader: true,
            "searchDelay": 350,
            "scrollX": true,
            ...
            "serverSide": true,
            "ajax": {
                url: '{{route("kategori.pemerintahan.desa.datatable")}}',
                // dataSrc: '',
                // draw: 'original.draw'
            },
            "columns": [
